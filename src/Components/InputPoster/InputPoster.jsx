...
export default function InputImageLook({ getImage, defaultImage, style }) {
  ...
  if (image.length !== 0)
    return (
      // <div className="dragDropContainerGap">
      //   <div className="containerImg" style={style}>
      //     <img
      //       src={image}
      //       alt="img"
      //       className="input-poster-img"
      //       onMouseOver={() => hoverImage("hover")}
      //     />
      //     <div
      //       className={hover ? "bgDelete" : ""}
      ...
      //     <div
      //       className={
      //         hover ? "displayNone buttonDeleteImgContainer" : "displayNone"
      //       }
      //     >
      //       <div
