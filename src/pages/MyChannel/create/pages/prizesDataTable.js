...
export const ConvertDataConcurs = (data) =>{
  ...
  return {
    concurs: {
      ...
      type: Conteststore.typesOfContest.filter(
        (type) => type.value === data.type_contest_id
      )[0],
...
export const GetJsonWinners = (data, limit, getOnlyJsonWinners = false) => {
  let a = [];
  ...
  return {
    ...data,
    json_winners: JSON.stringify(a.slice(0, limit)),
  };
}
